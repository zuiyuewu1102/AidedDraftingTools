...
namespace CommonClassLibrary
{
    public static class CUITools
    {
        ...
        /// <param name="index">子菜单在下拉菜单中的位置</param>
        ...
        /// 用于为菜单添加分割条
        /// </summary>
        /// <param name="parentMenu">分割条所属的菜单组</param>
        /// <param name="index">分割条的位置</param>
        /// <returns></returns>
        public static PopMenuItem AddSeparator(this PopMenu parentMenu,int index)
        {
            //定义一个分割条并返回
            return new PopMenuItem(parentMenu, index);//定义一个分割条并返回
        }
        ...
        /// 用于向工具栏添加弹出式工具栏
        /// </summary>
        /// <param name="parent">弹出式工具栏所属的父工具栏</param>
